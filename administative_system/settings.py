"""
Django settings for administative_system project.
...
SECRET_KEY = 'django-insecure-m2-y3+9n!s+znct7$u--vil9q)u6(h%%#v386k1r&%hw%(1muw'
...
ROOT_URLCONF = 'administative_system.urls'
...
WSGI_APPLICATION = 'administative_system.wsgi.application'
